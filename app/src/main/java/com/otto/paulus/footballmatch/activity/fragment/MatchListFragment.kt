...
import com.otto.paulus.footballmatch.adapter.MatchListAdapter
...
import com.otto.paulus.footballmatch.presenter.MatchListPresenter
...
class MatchListFragment : Fragment(),MatchListView, AnkoLogger {
    ...
    private var listType:Int = R.id.navigate_matches
