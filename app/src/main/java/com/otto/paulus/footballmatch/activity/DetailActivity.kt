...
import com.otto.paulus.footballmatch.R.string.label_added_to_favorite
import com.otto.paulus.footballmatch.R.string.label_removed_from_favorite
import com.otto.paulus.footballmatch.api.ApiRepository
import com.otto.paulus.footballmatch.db.FavoriteMatch
import com.otto.paulus.footballmatch.db.database
import com.otto.paulus.footballmatch.model.EventDetail
import com.otto.paulus.footballmatch.model.Team
import com.otto.paulus.footballmatch.presenter.MatchDetailPresenter
import com.otto.paulus.footballmatch.util.formatDate
import com.otto.paulus.footballmatch.util.invisible
import com.otto.paulus.footballmatch.util.parse
import com.otto.paulus.footballmatch.util.visible
...
class DetailActivity: AppCompatActivity(), MatchDetailView, AppBarLayout.OnOffsetChangedListener, AnkoLogger {
    ...
    override fun showDetailEvent(match: EventDetail) {
        ...
        tvHomeGoalKeeper.text = match.homeGoalKeeper?.parse()
        tvAwayGoalKeeper.text = match.awayGoalKeeper?.parse()
